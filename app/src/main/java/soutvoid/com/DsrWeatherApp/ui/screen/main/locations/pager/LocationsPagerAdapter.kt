...
class LocationsPagerAdapter(fragmentManager: FragmentManager,
     ...
     */
    val registeredFragments: SparseArray<WeakReference<LocationsListFragmentView>> = SparseArray()

    override fun getItem(position: Int): Fragment {
        when (position) {
            0 -> return LocationsListFragmentView.newInstance()
            1 -> return LocationsListFragmentView.newInstance(true)
        }
        return LocationsListFragmentView.newInstance()
    }
    ...
    override fun instantiateItem(container: ViewGroup?, position: Int): Any {
        val fragment = super.instantiateItem(container, position) as LocationsListFragmentView
     ...
     * @see LocationsListFragmentView.tryNotifyPagerDataSetChanged
     * @see LocationsListFragmentView.onDataSetChanged
     */
